...
public final class NewCatalogNodeVisualPanel1 extends JPanel implements Observer {
    ...
    public static final String NO_OBJECT = org.openide.util.NbBundle.getMessage(
            NewCatalogNodeVisualPanel1.class,
            "NewCatalogNodeVisualPanel1.NO_OBJECT"); // NOI18N
    ...
    /**
     * Creates a new NewCatalogNodeVisualPanel1 object.
     *
    ...
    private void init() {
        ...
        final JLabel lblLoading = new JLabel(
                org.openide.util.NbBundle.getMessage(
                    NewCatalogNodeVisualPanel1.class,
                    "NewCatalogNodeVisualPanel1.init().lblLoading.text")); // NOI18N
        lblLoading.setIcon(loadingIcon);
        final JLabel lblLoadingErr = new JLabel(
                org.openide.util.NbBundle.getMessage(
                    NewCatalogNodeVisualPanel1.class,
                    "NewCatalogNodeVisualPanel1.init().lblLoadingErr"));   // NOI18N
        ...
        final DefaultComboBoxModel dcbmClass = (DefaultComboBoxModel)cboClass.getModel();
        ...
        final Thread loadClassesThread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            final List<CidsClass> classes = model.getBackend().getAllEntities(CidsClass.class);
        ...
        final DefaultComboBoxModel dcbmDomains = (DefaultComboBoxModel)cboDomain.getModel();
        ...
        final DefaultComboBoxModel dcbmNodeTypes = (DefaultComboBoxModel)cboNodeType.getModel();
        ...
        txtNodeName.setText(org.openide.util.NbBundle.getMessage(
                NewCatalogNodeVisualPanel1.class,
                "NewCatalogNodeVisualPanel1.txtNodeName.text"));                  // NOI18N
        ...
        txtNodeName.getDocument().addDocumentListener(new DocumentListenerImpl());
    }
    ...
    private void initValues() {
        ...
        if (cc != null) {
            final DefaultComboBoxModel dcbm = (DefaultComboBoxModel)cboClass.getModel();
        ...
        if (url != null) {
            final DefaultComboBoxModel dcbm = (DefaultComboBoxModel)cboDesc.getModel();
    ...
    public String getName() {
        return org.openide.util.NbBundle.getMessage(
                NewCatalogNodeVisualPanel1.class,
                "NewCatalogNodeVisualPanel1.getName().returnvalue"); // NOI18N
    }
    ...
    private void initComponents() {
        org.openide.awt.Mnemonics.setLocalizedText(
            ...
            org.openide.util.NbBundle.getMessage(
                NewCatalogNodeVisualPanel1.class,
                "NewCatalogNodeVisualPanel1.lblNodeName.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(
            lblDesc,
            org.openide.util.NbBundle.getMessage(
                NewCatalogNodeVisualPanel1.class,
                "NewCatalogNodeVisualPanel1.lblDesc.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(
            lblClass,
            org.openide.util.NbBundle.getMessage(
                NewCatalogNodeVisualPanel1.class,
                "NewCatalogNodeVisualPanel1.lblClass.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(
            lblObject,
            org.openide.util.NbBundle.getMessage(
                NewCatalogNodeVisualPanel1.class,
                "NewCatalogNodeVisualPanel1.lblObject.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(
            lblNodeType,
            org.openide.util.NbBundle.getMessage(
                NewCatalogNodeVisualPanel1.class,
                "NewCatalogNodeVisualPanel1.lblNodeType.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(
            ...
            org.openide.util.NbBundle.getMessage(
                NewCatalogNodeVisualPanel1.class,
                "NewCatalogNodeVisualPanel1.lblDynChild")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(
            cboSqlSort,
            org.openide.util.NbBundle.getMessage(
                NewCatalogNodeVisualPanel1.class,
                "NewCatalogNodeVisualPanel1.cboSqlSort.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(
            ...
            org.openide.util.NbBundle.getMessage(
                NewCatalogNodeVisualPanel1.class,
                "NewCatalogNodeVisualPanel1.lblDomain.text")); // NOI18N
            ...
            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
                layout.createSequentialGroup().addContainerGap().add(
                    layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
                        ...
                        703,
                        Short.MAX_VALUE).add(
                        layout.createSequentialGroup().add(lblNodeName).add(26, 26, 26).add(
                            txtNodeName,
                            org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                            598,
                            Short.MAX_VALUE)).add(
                        ...
                        layout.createSequentialGroup().add(
                            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
                                layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false).add(
                                    lblDesc).add(cboDesc, 0, 300, Short.MAX_VALUE).add(
                                    cboNodeType,
                                    0,
                                    org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                    Short.MAX_VALUE)).add(lblNodeType)).addPreferredGap(
                            org.jdesktop.layout.LayoutStyle.RELATED,
                            106,
                            Short.MAX_VALUE).add(
                            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false).add(
                                txtObject).add(lblObject).add(
                                layout.createSequentialGroup().add(lblClass).add(259, 259, 259)).add(
                                cboClass,
                                0,
                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                Short.MAX_VALUE))).add(
                        ...
                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                        703,
                        Short.MAX_VALUE).add(lblDynChild).add(cboSqlSort).add(
                        jSeparator3,
                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                        703,
                        Short.MAX_VALUE).add(
                        ...
                        703,
                        Short.MAX_VALUE).add(
                        layout.createSequentialGroup().add(lblDomain).addPreferredGap(
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
                layout.createSequentialGroup().addContainerGap().add(
                    layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(lblNodeName).add(
                        txtNodeName,
                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                    ...
                    org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                    org.jdesktop.layout.LayoutStyle.RELATED).add(
                    layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(lblDesc).add(lblClass))
                    ...
                    layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(
                        ...
                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)).addPreferredGap(
                    org.jdesktop.layout.LayoutStyle.RELATED).add(
                    layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(lblNodeType).add(
                        lblObject)).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(
                    layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(
                        txtObject,
                        org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                    ...
                    10,
                    org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                    org.jdesktop.layout.LayoutStyle.RELATED).add(lblDynChild).addPreferredGap(
                    org.jdesktop.layout.LayoutStyle.RELATED).add(
                    jScrollPane1,
                    org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                    129,
                    org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).add(16, 16, 16).add(cboSqlSort).addPreferredGap(
                    org.jdesktop.layout.LayoutStyle.RELATED).add(
                    jSeparator3,
                    org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                    10,
    ...
    private final class CachingURLComboBoxModel extends DefaultComboBoxModel {
        ...
        /**
         * Creates a new CachingURLComboBoxModel object.
         */
        ...
        public void setSelectedItem(final Object anObject) {
            ...
            if (anObject.equals(lblSelect)) {
                final URL newURL = URLEditorPanel.showURLEditorDialog(model.getBackend());
                if (newURL == null) {
