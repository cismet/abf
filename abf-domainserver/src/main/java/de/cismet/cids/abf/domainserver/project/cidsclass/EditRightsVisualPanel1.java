/*
 * EditRightsVisualPanel1.java, encoding: UTF-8
 *
 * Copyright (C) by:
 *
 *----------------------------
...
public final class EditRightsVisualPanel1 extends JPanel
{
    ...
    private final static Policy VARIOUS_POLICIES;
    private final static Permission VARIOUS_PERMS;
    ...
    void init()
    {
        ...
        tblClasses.getSelectionModel().setSelectionInterval(0, model.
                getCidsClasses().length - 1);
    }
    ...
    private void initClasstable()
    {
        ...
        {
            data[i][0] = classes[i];
            data[i][1] = classes[i].getPolicy() == null ?
                Policy.NO_POLICY : classes[i].getPolicy();
            data[i][2] = classes[i].getAttributePolicy() == null ?
                Policy.NO_POLICY : classes[i].getAttributePolicy();
        }
        ...
        final LinkedList<Policy> policies = new LinkedList(someBackend
                .getAllEntities(Policy.class));
    ...
    private void updatePolicies(final Policy selectedPolicy)
    {
        ...
        final JXTable classesTable = (JXTable)tblClasses;
        final DefaultTableModel tModel = (DefaultTableModel)classesTable.
                getModel();
        ...
        for(int i = 0; i < rows.length; ++i)
        {
            ...
            if(rdbClassPolicy.isSelected())
            {
                ...
                selectedClasses.get(i).setPolicy(selectedPolicy.equals(Policy.
                        NO_POLICY) ? null : selectedPolicy);
            }
            if(rdbAttrPolicy.isSelected())
            {
                tModel.setValueAt(selectedPolicy, selRow, 2);
                selectedClasses.get(i).setAttributePolicy(selectedPolicy.equals(
    ...
    private void updateRights(final Permission selectedPerm)
    {
        ...
        final DefaultTableModel tModel = (DefaultTableModel)rightsTable.
                getModel();
                ...
                for(final ClassPermission perm : clazz.getClassPermissions())
                {
                    if(perm.getUserGroup().equals(ug))
                    {
                        ...
                        if(perm.getPermission().equals(pBefore))
                        {
                            ...
                            for(final ClassPermission cPerm : clazz.
                                    getClassPermissions())
                            {
                                if(cPerm.getUserGroup().equals(perm.
                                        getUserGroup()) &&
    ...
    private void updateRightsTable()
    {
        ...
        final DefaultTableModel rtModel =
                (DefaultTableModel)tblRights.getModel();
        final ListSelectionModel sModel = tblRights.getSelectionModel();
    ...
    private List<CidsClass> getSelectedClasses()
    {
        ...
        final JXTable classesTable = (JXTable)tblClasses;
        final DefaultTableModel ctModel =
                (DefaultTableModel)classesTable.getModel();
        final int[] rows = classesTable.getSelectedRows();
        final List<CidsClass> selClasses =
                new ArrayList<CidsClass>(rows.length);
        for(int i = 0; i < rows.length; ++i)
        {
            final int selRow = classesTable.convertRowIndexToModel(rows[i]);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(EditRightsVisualPanel1.class, "EditRightsVisualPanel1.jScrollPane1.border.title"))); // NOI18N
        jScrollPane1.setViewportView(tblClasses);

        jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(EditRightsVisualPanel1.class, "EditRightsVisualPanel1.jScrollPane2.border.title"))); // NOI18N
        jScrollPane2.setViewportView(tblRights);

        jScrollPane3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(EditRightsVisualPanel1.class, "EditRightsVisualPanel1.jScrollPane3.border.title"))); // NOI18N

        jScrollPane3.setViewportView(lstGroups);

        org.openide.awt.Mnemonics.setLocalizedText(rdbClassPolicy, org.openide.util.NbBundle.getMessage(EditRightsVisualPanel1.class, "EditRightsVisualPanel1.rdbClassPolicy.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(rdbAttrPolicy, org.openide.util.NbBundle.getMessage(EditRightsVisualPanel1.class, "EditRightsVisualPanel1.rdbAttrPolicy.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(EditRightsVisualPanel1.class, "EditRightsVisualPanel1.jLabel1.text")); // NOI18N

        org.jdesktop.layout.GroupLayout pnlClassesLayout = new org.jdesktop.layout.GroupLayout(pnlClasses);
        pnlClasses.setLayout(pnlClassesLayout);
        pnlClassesLayout.setHorizontalGroup(
            pnlClassesLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, pnlClassesLayout.createSequentialGroup()
                .add(jLabel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 77, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(pnlClassesLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(rdbClassPolicy)
                    .add(rdbAttrPolicy)
                    .add(cboPolicy, 0, 320, Short.MAX_VALUE))
                .add(0, 0, 0))
        );
        pnlClassesLayout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, pnlClassesLayout.createSequentialGroup()
                ...
                .add(rdbAttrPolicy)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(pnlClassesLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(EditRightsVisualPanel1.class, "EditRightsVisualPanel1.jLabel2.text")); // NOI18N

        org.jdesktop.layout.GroupLayout pnlRightsLayout = new org.jdesktop.layout.GroupLayout(pnlRights);
        pnlRights.setLayout(pnlRightsLayout);
        pnlRightsLayout.setHorizontalGroup(
            pnlRightsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, pnlRightsLayout.createSequentialGroup()
                .add(jLabel2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                .add(cboRight, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 194, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        );
        pnlRightsLayout.setVerticalGroup(
            pnlRightsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(pnlRightsLayout.createSequentialGroup()
                .addContainerGap(69, Short.MAX_VALUE)
                .add(pnlRightsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(pnlClasses, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(jScrollPane1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 292, Short.MAX_VALUE))
                .add(32, 32, 32)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(pnlRights, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(pnlClasses, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(pnlRights, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jScrollPane3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 431, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jScrollPane2, 0, 0, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jScrollPane1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 431, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private final class DragDropJXTable extends JXTable implements
            DragGestureListener,
            DragSourceListener,
            DropTargetListener
    {
    ...
    private final class DragDropJList extends JXList implements
            DragGestureListener,
            DragSourceListener,
            DropTargetListener
    {
    ...
    private final class ClassTableSelectionListener implements
    ...
    private final class RightsTableSelectionListener implements
            ListSelectionListener
    {
        @Override
        public void valueChanged(final ListSelectionEvent e)
    ...
    private final class RightRowRenderer extends DefaultTableCellRenderer
    {
                ...
                final int column)
        {
            ...
            c.setEnabled(unmarkedRightRows.contains(((JXTable)tblRights).
