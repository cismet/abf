/*
 * QueryManipulationWizardPanel1.java, encoding: UTF-8
 *
 * Copyright (C) by:
 *
 *----------------------------
...
public final class QueryManipulationWizardPanel1 extends Observable implements
        ...
        ChangeListener
{
    ...
    {
        if(!NameValidator.isValid(component.getQueryName(), NameValidator.
                NAME_HIGH))
        {
        ...
        try
        {
            final Query q = backend.getEntity(
                    Query.class, component.getQueryName());
