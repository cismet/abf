/*
 * IndexActionDialog.java, encoding: UTF-8
 *
 * Copyright (C) by:
 *
 *----------------------------
 ...
 *----------------------------
 *
 * Created on 04.06.2009, 15:16:32
 *
 */
 ...
 */
public class IndexActionDialog extends javax.swing.JDialog implements
        ProgressListener
{
    ...
    public IndexActionDialog(final Frame parent, final boolean modal, final int
            noOfClasses, final Cancelable cancelable)
    {
        super(parent, modal);
                ...
                EventQueue.invokeLater(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        lblOverallStatus.setText(MessageFormat.format(
                                statusString, currentClass, text));
    ...
    private void initComponents() {
        ...
        cmdCancel.setText(org.openide.util.NbBundle.getMessage(IndexActionDialog.class, "IndexActionDialog.cmdCancel.text")); // NOI18N
        ...
        lblStatus.setText(org.openide.util.NbBundle.getMessage(IndexActionDialog.class, "IndexActionDialog.lblStatus.text")); // NOI18N

        lblOverallStatus.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblOverallStatus.setText(org.openide.util.NbBundle.getMessage(IndexActionDialog.class, "IndexActionDialog.lblOverallStatus.text")); // NOI18N
        ...
        pnlProgressLayout.setHorizontalGroup(
            ...
            .add(pnlProgressLayout.createSequentialGroup()
                .addContainerGap()
                .add(pnlProgressLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(lblStatus, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 508, Short.MAX_VALUE)
                    .add(prgClass, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 508, Short.MAX_VALUE)
                    .add(lblOverallStatus, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 508, Short.MAX_VALUE)
                    .add(prgOverall, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 508, Short.MAX_VALUE))
                .addContainerGap())
        );
        pnlProgressLayout.setVerticalGroup(
            ...
            .add(pnlProgressLayout.createSequentialGroup()
                ...
                .add(prgClass, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(32, 32, 32)
                .add(lblOverallStatus)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        lblError.setText(org.openide.util.NbBundle.getMessage(IndexActionDialog.class, "IndexActionDialog.lblError.text")); // NOI18N
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
                        .add(24, 24, 24)
                        .add(lblError))
                    .add(pnlProgress, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .add(pnlProgress, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(lblError)
