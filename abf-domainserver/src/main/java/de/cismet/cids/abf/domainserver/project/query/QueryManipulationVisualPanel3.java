...
public final class QueryManipulationVisualPanel3 extends JPanel implements Observer {
    ...
    /**
     * Creates a new QueryManipulationVisualPanel3 object.
     *
    ...
    private void init() {
        ...
        final String group = org.openide.util.NbBundle.getMessage(
                QueryManipulationVisualPanel3.class,
                "QueryManipulationVisualPanel3.init().group");  // NOI18N
        final String right = org.openide.util.NbBundle.getMessage(
                QueryManipulationVisualPanel3.class,
                "QueryManipulationVisualPanel3.init().right");  // NOI18N
        final String domain = org.openide.util.NbBundle.getMessage(
                QueryManipulationVisualPanel3.class,
                "QueryManipulationVisualPanel3.init().domain"); // NOI18N
    ...
    class DnDJXTable extends JXTable implements DropTargetListener, DragGestureListener, DragSourceListener {
        ...
        public void drop(final DropTargetDropEvent dtde) {
            if (LOG.isDebugEnabled()) {
                ...
                LOG.debug(((DropTarget)dtde.getSource()).getComponent().equals(this));
            }
            try {
                ...
                if (o instanceof Object[]) {
                    ...
                    final DefaultTableModel tModel = (DefaultTableModel)getModel();
                    final DefaultListModel lModel = (DefaultListModel)((JXList)lstGroup).getWrappedModel();
                    ...
                    for (final UserGroup ug : ugs) {
                        tModel.addRow(
                            new Object[] { ug, cboRight.getSelectedItem(), defaultDomain });
                    }
                }
        ...
        public void drop(final DropTargetDropEvent dtde) {
            ...
            try {
                ...
                if (o instanceof Object[]) {
                    ...
                    final Integer[] indices = (Integer[])dropped[1];
                    final UserGroup[] ugs = (UserGroup[])dropped[2];
                    final DefaultListModel lModel = (DefaultListModel)getWrappedModel();
                    final DefaultTableModel tModel = (DefaultTableModel)tblRights.getModel();
                    for (final int index : indices) {
                        tModel.removeRow(index);
                    }
