/*
 * RegistryProjectFactory.java, encoding: UTF-8
 *
 * Copyright (C) by:
 *
 *----------------------------
 ...
 *----------------------------
 *
 * Created on 29. September 2006, 10:27
 *
 */
...
public class RegistryProjectFactory implements ProjectFactory
{
            ...
            ClassCastException
    {
        ...
        final Properties properties = project.getLookup().lookup(
                Properties.class);
        properties.store(new FileOutputStream(FileUtil.toFile(propertiesFile)),
                "Cids Registry Project Properties"); // NOI18N
    }
