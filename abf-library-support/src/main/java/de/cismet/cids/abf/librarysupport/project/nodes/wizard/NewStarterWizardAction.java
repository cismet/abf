...
public final class NewStarterWizardAction extends NodeAction
{
    ...
    public static final String PROP_NEW_STARTER_BASE_FILE = 
            "property_newStarterBaseFile"; // NOI18N
    public static final String PROP_NEW_STARTER_NAME = 
    ...
    protected void performAction(final Node[] nodes)
    {
        ...
        if(!cancelled)
        {
            ...
            final String manName = wizard.getProperty(PROP_NEW_STARTER_NAME).
                    toString();
            try
            {
                ...
                if(file.exists() && file.isFile())
                {
                    ...
                    final String tPath = FileUtil.toFile(srcDir).
                            getAbsolutePath();
                    file = new File(tPath);
