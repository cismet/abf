/*
 * DeployAllJarsAction.java, encoding: UTF-8
 *
 * Copyright (C) by:
 *
 *----------------------------
...
public final class DeployAllJarsAction extends NodeAction
{
    ...
    protected boolean enable(final Node[] nodes)
    {
        ...
        for(final Node n : nodes)
        {
            final LocalManagementContextCookie l = (
                    LocalManagementContextCookie)n.getCookie(
                    LocalManagementContextCookie.class);
            final StarterManagementContextCookie s = (
                    StarterManagementContextCookie)n.getCookie(
