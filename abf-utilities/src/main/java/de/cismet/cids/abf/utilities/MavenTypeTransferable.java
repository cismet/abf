...
public final class MavenTypeTransferable implements Transferable {
    ...
    public static final DataFlavor ARTIFACT_LIST_FLAVOR = new DataFlavor(
            DataFlavor.javaJVMLocalObjectMimeType,
            "MavenArtifactList"); // NOI18N
     ...
     * @param  o  DOCUMENT ME!
     */
    public MavenTypeTransferable(final Object o) {
        this.o = o;
    }
    ...
    public boolean isDataFlavorSupported(final DataFlavor flavor) {
        return flavor.match(ARTIFACT_LIST_FLAVOR);
    }
    ...
    public Object getTransferData(final DataFlavor flavor) throws UnsupportedFlavorException, IOException {
        return flavor.match(ARTIFACT_LIST_FLAVOR) ? o : null;
    }
